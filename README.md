...
[![v0.5.21](https://img.shields.io/badge/release-v0.5.21-orange)](https://github.com/zzallirog/coolstep/releases/tag/v0.5.21)
[![tests](https://img.shields.io/badge/tests-1025_passed-brightgreen)](#tested-against)
...
→ [`docs/security.md`](docs/security.md) · [`docs/headless-deployment.md`](docs/headless-deployment.md) · [`SECURITY.md`](SECURITY.md)
...
| P2.10 — workload awareness rework (Profile.BROWSER, `steam_app_*` prefix, reactive slope_preload, background-vote resolver) | ✅ v0.5.13 |
