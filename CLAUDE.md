...
> `docs/p2.10-workload-awareness-rework.md`. Adds `Profile.BROWSER`,
> `steam_app_*` prefix → GAME, reactive `slope_preload` policy, and
> «background contributes» resolver semantics. 813 tests green.
