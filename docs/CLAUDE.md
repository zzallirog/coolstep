...
├── aur-publishing.md             # AUR readiness methodology + gotchas + FAQ (user/dev)
├── p2.5-rollup.md                # P2.5 batch (2026-05-12): 8-policy pipeline + Profile.*
├── p2.10-workload-awareness-rework.md  # P2.10 batch (2026-05-16): browser bucket + slope_preload + bg-detect
...
A: НЕ в docs/. Личное workspace вне репо — здесь только ratified.
