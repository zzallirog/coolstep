...
from coolstep.core.workload_profile import GAME_CLASSES, RENDER_CLASSES
...
def test_workload_no_op_unknown_class():
    ...
    assert out == _BASE
    ctx2 = CurveContext(workload_class="zen")  # not in known-hot list
...
def test_workload_classes_headroom_derived_from_profiles():
    """Single source of truth — must equal RENDER ∪ GAME from workload_profile."""
    assert WORKLOAD_CLASSES_HEADROOM == (RENDER_CLASSES | GAME_CLASSES)
